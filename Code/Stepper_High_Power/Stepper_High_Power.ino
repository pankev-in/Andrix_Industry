/*
  Name:            Stepper Motor Controller (Serial Communication) - 4.5A high power version
  Autor:           Alexander Wurm, Kevin Pan
  Discribtion:     Stepper Motor Controller (Serial Communication) - 4.5A high power version

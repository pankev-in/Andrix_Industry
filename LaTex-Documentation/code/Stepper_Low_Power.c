/*
  Name:            Stepper Motor Controller (Serial Communication) - 3.5A low power
  Autor:           Alexander Wurm, Kevin Pan
  Discribtion:     Stepper Motor Controller (Serial Communication) - 3.5A low power
  Last Update:     04.2015
